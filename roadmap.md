...
- [x] Add separately scoped paid follow-on services after the Sprint on both public pages
- [x] Review add-on links, FAQ, free-check validation and responsive preview
...
- [x] Expand AI Visibility methodology and offer progression
...
# Revenue Leakage integration (preview only, no publish)

- [x] Rework commercial context into three connected areas and show it on the homepage
- [x] Add /revenue-leakage route with funnel, leak examples, offer path and CTA
- [x] Add Revenue Leakage Snapshot form, server function and internal notification email
- [x] Extend funnel attribution event names and page-aware analytics
