...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AI Buyer Intelligence & Growth" },
      {
        name: "description",
        content:
          "AI buyer intelligence for B2B brands: measure, diagnose and improve how AI assistants represent you in buying journeys.",
      },
